...
class ShortText():
    ...
    # small text to KB
    def from_small_text_to_kb(self,model,tokenizer,text, verbose=False):
        kb = KB()
...
if __name__=="__main__":
    ...
    obj=ShortText()
    model,tokenizer=obj.model_tokenizer()
    kb=obj.from_small_text_to_kb(model,tokenizer,text)
    kb.print()
